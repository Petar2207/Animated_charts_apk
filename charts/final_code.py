...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.page_lay.addWidget(self.plot_container)
    ...
    def export_mp4(self):
        ...
        # --- Progress dialog (small window) ---
        total = self.total_frames_with_pause
        progress = QProgressDialog("Exporting video...\nPlease wait.", "Cancel", 0, total, self)
        ...
        try:
            ...
            with writer.saving(self.canvas.figure, tmp_path, dpi=150):
                for f in range(total):
                    ...
                    # Update progress UI (don’t do it every single frame if you want it smoother)
                    if f % 2 == 0 or f == total - 1:
