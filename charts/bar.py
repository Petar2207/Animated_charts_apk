...
class MainWindow(QMainWindow):
    ...
    def export_mp4(self):
        ...
        # --- Progress dialog ---
        total = int(self.total_frames_with_pause)
        ...
        try:
            ...
            if self.show_line1:
                ax.plot(
                    self.x, self.line1_vals, linestyle="-", linewidth=1, color=DEFAULT_LINE_COLOR,
                    marker="o", markersize=0, label=self.label_line1, alpha=0.9
                )

            if self.show_line2:
                ax.plot(
                    self.x, self.line2_vals, linestyle="--", linewidth=1, color=DEFAULT_LINE_COLOR,
            ...
            with writer.saving(fig, tmp_path, dpi=300):
                for frame in range(total):
                    ...
                    # progress update (throttle a bit)
